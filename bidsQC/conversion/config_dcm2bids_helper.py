...
# Test subject
test_subject =  os.path.join("REV055_20150811_135636") # Name of a directory that contains DICOMS for one participant. Must be subfolder of pathToDicomsFolder. E.g. pathToDicomsFolder/S001
